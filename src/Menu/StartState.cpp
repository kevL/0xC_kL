...
void StartState::init()
{
	...
	_game->setResourcePack(nullptr);
	if (Options::mute == false && Options::reload == true)
	{
		Mix_CloseAudio();
		_game->initAudio();
	}
 ...
 * @return, thread-status 0= okay
 */
int StartState::load(void* ptrG)
{
