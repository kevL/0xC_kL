...
/*
static inline void scale3x_8_def_whole(
		scale3x_uint8* restrict dst0,
		scale3x_uint8* restrict dst1,
		scale3x_uint8* restrict dst2,
		const scale3x_uint8* restrict src0,
		const scale3x_uint8* restrict src1,
		const scale3x_uint8* restrict src2,
		unsigned count)
{
	assert(count >= 2);
...
static inline void scale3x_8_def_border(
		scale3x_uint8* restrict dst,
		const scale3x_uint8* restrict src0,
		const scale3x_uint8* restrict src1,
		const scale3x_uint8* restrict src2,
		unsigned count)
...
static inline void scale3x_8_def_center(
		scale3x_uint8* restrict dst,
		const scale3x_uint8* restrict src0,
		const scale3x_uint8* restrict src1,
		const scale3x_uint8* restrict src2,
...
/*
static inline void scale3x_16_def_whole(
		scale3x_uint16* restrict dst0,
		scale3x_uint16* restrict dst1,
		scale3x_uint16* restrict dst2,
		const scale3x_uint16* restrict src0,
		const scale3x_uint16* restrict src1,
		const scale3x_uint16* restrict src2,
		unsigned count)
{
	assert(count >= 2);
...
static inline void scale3x_16_def_border(
		scale3x_uint16* restrict dst,
		const scale3x_uint16* restrict src0,
		const scale3x_uint16* restrict src1,
		const scale3x_uint16* restrict src2,
		unsigned count)
...
static inline void scale3x_16_def_center(
		scale3x_uint16* restrict dst,
		const scale3x_uint16* restrict src0,
		const scale3x_uint16* restrict src1,
		const scale3x_uint16* restrict src2,
...
/*
static inline void scale3x_32_def_whole(
		scale3x_uint32* restrict dst0,
		scale3x_uint32* restrict dst1,
		scale3x_uint32* restrict dst2,
		const scale3x_uint32* restrict src0,
		const scale3x_uint32* restrict src1,
		const scale3x_uint32* restrict src2,
		unsigned count)
{
	assert(count >= 2);
...
static inline void scale3x_32_def_border(
		scale3x_uint32* restrict dst,
		const scale3x_uint32* restrict src0,
		const scale3x_uint32* restrict src1,
		const scale3x_uint32* restrict src2,
		unsigned count)
...
static inline void scale3x_32_def_center(
		scale3x_uint32* restrict dst,
		const scale3x_uint32* restrict src0,
		const scale3x_uint32* restrict src1,
		const scale3x_uint32* restrict src2,
		...
		unsigned count)
{
	...
	scale3x_8_def_whole(dst0,
			...
			count);
#else
	scale3x_8_def_border(dst0,
			src0,
			src1,
			src2,
			count);
	scale3x_8_def_center(dst1,
			src0,
			src1,
			src2,
			count);
	scale3x_8_def_border(dst2,
			src2,
			src1,
			src0,
			count);
		...
		unsigned count)
{
	...
	scale3x_16_def_whole(dst0,
			...
			count);
#else
	scale3x_16_def_border(dst0,
			src0,
			src1,
			src2,
			count);
	scale3x_16_def_center(dst1,
			src0,
			src1,
			src2,
			count);
	scale3x_16_def_border(dst2,
			src2,
			src1,
			src0,
			count);
		...
		unsigned count)
{
	...
	scale3x_32_def_whole(dst0,
			...
			count);
#else
	scale3x_32_def_border(dst0,
			src0,
			src1,
			src2,
			count);
	scale3x_32_def_center(dst1,
			src0,
			src1,
			src2,
			count);
	scale3x_32_def_border(dst2,
			src2,
			src1,
			src0,
			count);
